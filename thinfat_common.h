...
typedef enum
{
  ...
  THINFAT_CORE_EVENT_FIND_FILE_BY_LONGNAME,
  THINFAT_CORE_EVENT_READ_FILE,
  THINFAT_CORE_EVENT_READ_FILE_PREPARE,
  THINFAT_CORE_EVENT_WRITE_FILE,
  THINFAT_CORE_EVENT_WRITE_FILE_PREPARE,
  THINFAT_CORE_EVENT_WRITE_FILE_FINISH,
